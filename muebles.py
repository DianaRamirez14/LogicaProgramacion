...
if __name__ == '__main__':
	muebles = int()
	print("Ingrese la cantidad de muebles que va a comprar")
	muebles = int(input())
	multi = muebles*800000
	if muebles<5:
		des1 = multi-(multi*0.1)
		print("¡Tiene un descuento del 10%!, el total de su compra es de: ",des1)
	else:
		if muebles>=5 and muebles<10:
			des2 = multi-(multi*0.2)
			print("!Tiene un descuento del 20%!, el total de su compra es de: ",des2)
		else:
			if muebles>=10:
				des3 = multi-(multi*0.4)
				print("!Tiene un descuento del 40%!, el total de su compra es de: ",des3)
			else:
				print("No ibtuvo ningun descuento en su compra")
